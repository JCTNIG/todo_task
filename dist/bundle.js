...
// Module
___CSS_LOADER_EXPORT___.push([module.id, `/* Center the modal and create a backdrop */
.modal-backdrop {
  position: fixed;
  top: 0;
  left: 0;
...
`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA,2CAA2C;AAC3C;EACE,eAAe;EACf,MAAM;EACN,OAAO;EACP,WAAW;EACX,YAAY;EACZ,oCAAoC,EAAE,gCAAgC;EACtE,aAAa;EACb,uBAAuB;EACvB,mBAAmB;EACnB,aAAa;AACf;;AAEA;EACE,sBAAsB;EACtB,aAAa;EACb,kBAAkB;EAClB,wCAAwC;EACxC,aAAa;AACf","sourcesContent":["/* Center the modal and create a backdrop */\n.modal-backdrop {\n  position: fixed;\n  top: 0;\n  left: 0;\n  width: 100%;\n  height: 100%;\n  background-color: rgba(0, 0, 0, 0.5); /* Semi-transparent background */\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  z-index: 1000;\n}\n\n.modal {\n  background-color: #fff;\n  padding: 20px;\n  border-radius: 8px;\n  box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);\n  z-index: 1001;\n}\n"],"sourceRoot":""}]);
// Exports
...
function inputSection() {
  ...
  form.addEventListener('submit', (event) => {
    ...
    const now = new Date();
    const idDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.format)(now, 'MM/dd_HH:mm:ss');
    (0,_todoManager__WEBPACK_IMPORTED_MODULE_1__.createTodo)(titleInput.value, descriptionInput.value, dueInput.value, `${idDate}T`);
...
function displayTaskList() {
  ...
  main.innerHTML = '';
  const taskList = _storage__WEBPACK_IMPORTED_MODULE_0__.localList.getList('taskList') || [];
  ...
  taskList.forEach(task => {
    ...
    taskDeleteBtn.addEventListener('click', () => {
      (0,_todoManager__WEBPACK_IMPORTED_MODULE_1__.deleteTodo)(task.id);
      displayTaskList();
    });
...
class Project{
  constructor(title, description, due, id){
    this.title = title;
...
let newProjectList = _storage__WEBPACK_IMPORTED_MODULE_1__.localList.getList('projectList');

function createProject(title, description, due, id) {
  const newProject = new _projectClass__WEBPACK_IMPORTED_MODULE_0__.Project(title, description, due, id);
  newProjectList.push(newProject);

  _storage__WEBPACK_IMPORTED_MODULE_1__.localList.save('projectList', newProjectList);
};
...
const now = new Date();
const projectId = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.format)(now, 'MM/dd_HH:mm:ss');
...
const projectList = _storage__WEBPACK_IMPORTED_MODULE_1__.localList.getList('projectList');
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   localList: () => (/* binding */ localList)
/* harmony export */ });
...
/* harmony export */ });
class Todo {
  constructor(title, description, due, id, project) {
    this.title = title;
    this.description = description;
    this.due = due;
    this.id = id;
...
let todoList = _storage_js__WEBPACK_IMPORTED_MODULE_0__.localList.getList('taskList') || [];

function createTodo(title, description, due, id, project) {
  const newTodo = new _todoClass_js__WEBPACK_IMPORTED_MODULE_1__.Todo(title, description, due, id, project);

  todoList.push(newTodo);

  _storage_js__WEBPACK_IMPORTED_MODULE_0__.localList.save('taskList', todoList);
...
function addTodoProject(todoId, projectId) {
...
let taskList = _storage_js__WEBPACK_IMPORTED_MODULE_0__.localList.getList('taskList');
...
/* harmony import */ var _displayFunctions__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./displayFunctions */ "./src/displayFunctions.js");
...
addTaskBtn.addEventListener('click', () => {
  (0,_displayFunctions__WEBPACK_IMPORTED_MODULE_1__.inputSection)();
});


(0,_displayFunctions__WEBPACK_IMPORTED_MODULE_1__.displayTaskList)()
